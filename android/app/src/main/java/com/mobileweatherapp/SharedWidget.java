...
public class SharedWidget extends ReactContextBaseJavaModule {
    ReactApplicationContext context;

    public SharedWidget(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void set(String message) {
        ...
        Intent intent = new Intent(getCurrentActivity().getApplicationContext(), WeatherWidget.class);
